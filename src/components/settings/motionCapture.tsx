        ...
        <div className="flex flex-col gap-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="mb-4">
                    ...
                    <TextButton onClick={() => settingsStore.setState({ enableMotionCapture: !enableMotionCapture })}>
                ...
                <div className="mb-4">
                    ...
                    <TextButton onClick={() => settingsStore.setState({ enableFaceTracking: !enableFaceTracking })}>
                ...
                <div className="mb-4">
                    ...
                    <TextButton onClick={() => settingsStore.setState({ enableUpperBodyTracking: !enableUpperBodyTracking })}>
                ...
                <div className="mb-4">
                    ...
                    <TextButton onClick={() => settingsStore.setState({ enableHipsTracking: !enableHipsTracking })}>
                ...
                <div className="mb-4">
                    ...
                    <TextButton onClick={() => settingsStore.setState({ enableLegTracking: !enableLegTracking })}>
